...
export const PROJECTS: Project[] = [
  {
    ...
    images: [
      "/images/bare-metal-paas-1.webp",
      "/images/bare-metal-paas-2.webp",
      "/images/bare-metal-paas-3.webp",
    ],
    links: [
      {
  ...
  },
  {
    ...
    title: "USrc",
    description: {
      en: "High-performance media interface using Vite, TanStack Query, and Bun server with intelligent caching.",
      tr: "Vite, TanStack Query ve akıllı önbellekli Bun sunucusu ile yüksek performanslı medya arayüzü.",
    },
    detailedDescription: {
      en: "Engineered with Vite 7 and React 19 for rapid development and optimized builds. Utilizes TanStack Router for type-safe file-based routing and TanStack Query for efficient data fetching and caching. A custom Bun server powers the API layer with a 2-hour memory cache and Brotli/Gzip compression to minimize TMDB API usage and accelerate responses. Client-side watchlist state persists via localStorage, while video content streams through embedded iframes. The UI is built with Tailwind CSS 4, ensuring a responsive and modern viewing experience across devices.",
      tr: "Hızlı geliştirme ve optimize edilmiş derlemeler için Vite 7 ve React 19 ile geliştirildi. Tip güvenli dosya tabanlı yönlendirme için TanStack Router, verimli veri çekimi ve önbellekleme için TanStack Query kullanır. Özel Bun sunucusu, 2 saatlik bellek önbelleği ve Brotli/Gzip sıkıştırma ile API katmanını güçlendirirerek TMDB API kullanımını minimize eder ve yanıt sürelerini hızlandırır. İzleme listesi durumu istemci tarafında localStorage üzerinden kalıcı hale getirilirken, video içeriği gömülü iframe'ler üzerinden yayınlanır. Arayüz, cihazlar arası duyarlı ve modern bir izleme deneyimi sunmak için Tailwind CSS 4 ile oluşturulmuştur.",
    },
    technologies: [
      "Vite",
      "TanStack",
  ...
  },
  {
    ...
    images: [
      "/images/scheduler-1.webp",
      "/images/scheduler-2.webp",
      "/images/scheduler-3.webp",
    ],
    links: [
      {
        labelKey: "projects.viewLive",
